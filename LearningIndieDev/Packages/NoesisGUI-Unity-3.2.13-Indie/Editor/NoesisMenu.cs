...
public class NoesisMenu
{
    ...
    private static void CreateXaml(string content)
    {
      ...
      #if UNITY_6000_4_OR_NEWER
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(EntityId.None, action, "New Xaml.xaml", icon, null);
      #else
  ...
  #if UNITY_6000_4_OR_NEWER
    internal class DoCreateUserControl : AssetCreationEndAction
  #else
    ...
    static void CreateUserControl()
    {
        ...
        Texture2D icon = (Texture2D)AssetDatabase.LoadAssetAtPath("Packages/com.noesis.noesisgui/Editor/icon.png", typeof(Texture2D));
      #if UNITY_6000_4_OR_NEWER
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(EntityId.None, action, "UserControl.xaml", icon, null);
      #else
