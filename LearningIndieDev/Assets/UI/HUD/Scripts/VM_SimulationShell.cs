            ...
            Set(
                ...
                showExperimentalUpgradeCount
                    ? string.Format(
                        ...
                        "BEV EXPERIMENTAL UPGRADES: {0} | TOUGH HIDE Lv {1} | DIGESTION Lv {2} | CROWDING Lv {3} | THREAT EXPOSURE Lv {4}",
                        ...
                        preview.GetUpgradeLevel(SpeciesUpgradeCatalog.ThreatExposureId))
                    : string.Empty,
